...
class App extends Component {
  ...
  async handleSubmit(event) {
    ...
    const note = {"note":this.state.value, "description": description.value}
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">SA Request Form</h1>
        </header>
        <br/>
          ...
          {this.state.displayAdd ?
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="input-group mb-3">
                <input type="text" className="form-control form-control-lg" placeholder="Title" aria-label="Note" aria-describedby="basic-addon2" value={this.state.value} onChange={this.handleChange}/>
              </div>
